...
#include <corecrt_memory.h>
	...
	Gost34_2012::Gost34_2012()
	{
	}

	const unsigned char Gost34_2012::Pi[256] = {
	...
	const unsigned char Gost34_2012::Tau[64] = {
	...
	const unsigned long long Gost34_2012::A[64] = {
	...
	const unsigned char Gost34_2012::C[12][64] = {
		{
	...
	void Gost34_2012::GOSTHashX(const uint8_t* a, const uint8_t* b, uint8_t* c)
	{
		for (int i = 0; i < 64; i++)
			c[i] = a[i] ^ b[i];
	}
	...
	void Gost34_2012::GOSTHashAdd512(const uint8_t* a, const uint8_t* b, uint8_t* c)
	{
		int internal = 0;
		for (int i = 0; i < 64; i++)
		{
	...
	void Gost34_2012::GOSTHashS(uint8_t* state)
	{
		vect internal;
		for (int i = 63; i >= 0; i--)
		{
	...
	void Gost34_2012::GOSTHashP(uint8_t* state)
	{
		vect internal;
		for (int i = 63; i >= 0; i--)
	...
	void Gost34_2012::GOSTHashL(uint8_t* state)
	{
	...
	void Gost34_2012::GOSTHashE(uint8_t* k, const uint8_t* m, uint8_t* state)
	{
	...
	void Gost34_2012::GOSTHashG(uint8_t* h, uint8_t* n, const uint8_t* m)
	{
		vect k, internal;
		GOSTHashX(n, h, k);
	...
	void Gost34_2012::GOSTHashPadding(TGOSTHashContext* ctx)
	{
		vect internal;
	...
	void Gost34_2012::GOSTHashUpdate(TGOSTHashContext* ctx, const uint8_t* data, size_t len)
	{
	...
	void Gost34_2012::GOSTHashFinal(TGOSTHashContext* ctx)
	{
		GOSTHashStage_3(ctx);
		ctx->buf_size = 0;
	}

	void Gost34_2012::GOSTHashGetKey(uint8_t* k, int i)
	{
		GOSTHashX(k, C[i], k);
		GOSTHashS(k);
		GOSTHashP(k);
	...
	void Gost34_2012::GOSTHashInit(TGOSTHashContext* ctx, uint16_t hash_size)
	{
	...
	void Gost34_2012::GOSTHashStage_2(TGOSTHashContext* ctx, const uint8_t* data)
	{
	...
	void Gost34_2012::GOSTHashStage_3(TGOSTHashContext* ctx)
	{
		vect internal;
